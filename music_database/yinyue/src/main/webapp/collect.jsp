...
<center>
	...
	<td>    <img src="images/我的收藏.png" id="log"/></td>
</table>
...
<% 
			...
			String sql="select c.plist_id,c.plist_name from collect a inner join user b on a.user_id=b.user_id inner join plist c on a.plist_id=c.plist_id where user_name="+"\'"+name+"\'";
		...
		输入歌单id:<input type="text" name="pid">
		<br/>

		<br/>
		<input type="submit" value="查看歌单详细信息"/>
